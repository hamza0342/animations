...
import './App.css';
import './images/sprite_running-alice-queen_small.png';
...
function App() {
    ...
    const earthMovement = useWebAnimations({
      keyframes: earthFrames,
      timing: sceneryTimingBackground
    })
    ...
    return (
      <div>
        <div className="wrapper">
          ...
          <div className="earth" id="eart" ref={earthMovement.ref}>
